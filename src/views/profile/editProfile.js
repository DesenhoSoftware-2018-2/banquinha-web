          ...
          <div class="row container profile-form">
            <form class="col s12">
              ...
              <div class="row">
                <div class="input-field col s6">
                  <input
                    ...
                    class="validate"
                  />
                  <label class="active" for="facebook">
                    Facebook
                  </label>
                </div>
                <div class="input-field col s6">
                  <input
                    ...
                    class="validate"
                  />
                  <label class="active" for="linkedin">
                    Linkedin
                  </label>
                </div>
                <div class="input-field col s6">
                  <input
                    ...
                    class="validate"
                  />
                  <label class="active" for="instagram">
                    Instagram
                  </label>
                </div>
                <div class="input-field col s6">
                  <input
                    ...
                    class="validate"
                  />
                  <label class="active" for="twitter">
                    Twitter
                  </label>
                </div>
              </div>
              ...
              <div class="row btn-form">
                ...
                <Link to="/perfil" class="waves-effect waves-light btn">
                  Cancelar
                </Link>
              </div>
            </form>
